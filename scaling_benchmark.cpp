...
const char* images[] = {
	"../../scaling_jpgs/zebras_13.jpg",
	"../../scaling_jpgs/zebras_12.jpg",
	"../../scaling_jpgs/zebras_11.jpg",
	"../../scaling_jpgs/zebras_10.jpg",
	"../../scaling_jpgs/zebras_9.jpg",
	"../../scaling_jpgs/zebras_8.jpg",
	"../../scaling_jpgs/zebras_7.jpg",
	"../../scaling_jpgs/zebras_6.jpg",
	"../../scaling_jpgs/zebras_5.jpg",
	"../../scaling_jpgs/zebras_4.jpg",
	"../../scaling_jpgs/zebras_3.jpg",
	"../../scaling_jpgs/zebras_2.jpg",
	"../../scaling_jpgs/zebras_1.jpg"
};
...
read_JPEG_file (unverified_data<unsigned char *> fileBuff, unsigned long fsize)
{
  ...
  *p_buffer = pBufferVal;
  ...
  unverified_data<JSAMPLE*> image_buffer = newInSandbox<JSAMPLE>(sandbox, image_width * image_height * 3 * sizeof(JSAMPLE));
